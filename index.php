...
<!-- <link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet"> -->
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <a href="/relogios.html"><h2 class="my-3">Relógios</h2></a>
                        
                    </div>
                    <div class="col-md-4">
                        <img class="mb-4" src="/imagens/Carteira/Carteira Marrom.jfif" width="250px">
                        <a href="/carteiras.html"><h2 class="my-4">Carteiras</h2></a>
                       
                    </div>
                    <div class="col-md-4">
                        <img class="mb-4" src="/imagens/oculos/Oculos3.jfif"  width="250px">
                        <a href="/oculos.html"><h2 class="my-3">Óculos</h2></a>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Sobre</h2> <br><br>
                </div>
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Estamos no mercado há 15 anos, entregando produtos de qualidades</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>2013</h4>
                                <h4 class="subheading">Reforma</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Em 2013 tivemos um avanço muito grande de vendes, sendo a segunda loja com maior número de vendas do Brasil</p></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Localização</h4>
                                <h4 class="subheading">Rio de Janeiro</h4>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="team-member">
                            ...
                            <h4>Eduardo</h4>
                            <p class="text-muted">Desisgner</p>
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!-- Name input-->
                                <input class="form-control" id="name" type="text" placeholder="Seu Name *" data-sb-validations="required" />
